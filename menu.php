...
$plats = $recette->plats();
$platsAutres = $recette->platsAutres();
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Notre Menu Populaire</h1>
                </div>
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 ms-0 pb-3 active" data-bs-toggle="pill" href="#tab-1">
                                ...
                                <div class="ps-3">
                                    ...
                                    <h6 class="mt-n1 mb-0">De nos divers plats</h6>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 pb-3" data-bs-toggle="pill" href="#tab-2">
                                <i class="fa fa-list fa-2x text-primary"></i>
                                <div class="ps-3">
                                    <small class="text-body">Menus</small>
                                    <h6 class="mt-n1 mb-0">Autres Plats</h6>
                                </div>
                            </a>
                        </li>
                    ...
                    <div class="tab-content">
                                ...
                                <?php foreach($plats as $plat):?>
                                    <div class="col-lg-6">
                                        <div class="d-flex align-items-center">
                                            <img class="flex-shrink-0 img-fluid rounded" src="img/<?= $plat['photo_path']?>" alt="" style="width: 100px; height:90px">
                                            <div class="w-100 d-flex flex-column text-start ps-4">
                                                <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                    <span><a href="booking.php?plat=<?= $plat['id']?>" class="nav-item nav-link" onclick="confirm('Connectez-vous  avant de passer votre réservation, si vous l\'avez pas encore fait ☺')"><?= $plat['nom']?></a></span>
                                                    <span class="text-primary"><?= $plat['prix']?></span>
                                                </h5>
                                                <small class="fst-italic"><?= $plat['details']?></small>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach?>
                      ...
                      <div id="tab-2" class="tab-pane fade show p-0">
                            <div class="row g-4">
                            <?php foreach($platsAutres as $plat):?>
                                <div class="col-lg-6">
                                        <div class="d-flex align-items-center">
                                            <img class="flex-shrink-0 img-fluid rounded" src="img/<?= $plat['photo_path']?>" alt="" style="width: 100px; height:90px">
                                            <div class="w-100 d-flex flex-column text-start ps-4">
